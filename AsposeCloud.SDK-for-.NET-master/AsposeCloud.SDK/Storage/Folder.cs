...
namespace Aspose.Cloud.Storage
{
    ...
    public class Folder
    {
        ...
        private string strURIFolder = Aspose.Cloud.Common.Product.BaseProductUri + "/storage/folder/";
        private string strURIFile = Aspose.Cloud.Common.Product.BaseProductUri + "/storage/file/";
        private string strURIExist = Aspose.Cloud.Common.Product.BaseProductUri + "/storage/exist/";
        private string strURIDisc = Aspose.Cloud.Common.Product.BaseProductUri + "/storage/disc/";

        /// <summary>
        /// Sets or gets the app info for which operations to be performed.
        /// </summary>
        public AsposeApp app { get; set; }
        /// <summary>
        /// Retrives the list of files and folders under the specified folder. Use empty string to specify root folder.
        /// </summary>
        /// <param name="strFolder"></param>
        /// <returns></returns>
        public List<Aspose.Cloud.Storage.File> GetFilesList(string strFolder)
        {
            try
            {
        ...
        /// <returns></returns>
        public List<Aspose.Cloud.Storage.File> GetFilesList(string strFolder, StorageType storageType, string storageName)
        {
            try
            {

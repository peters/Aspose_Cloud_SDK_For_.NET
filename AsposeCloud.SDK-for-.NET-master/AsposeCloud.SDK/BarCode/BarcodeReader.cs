...
namespace Aspose.Cloud.BarCode
{
    ...
    public class BarCodeReader
    {
        ...
        /// and then recognized using Aspose.Cloud.BarCode. Result will be returned to client
        /// </summary>
        ...
        public List<RecognizedBarCode> Read(string url, BarCodeReadType readType)
        {
            ...
            // Build URI for accessing Aspose.Cloud.BarCode API
